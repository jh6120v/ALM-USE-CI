                ...
                <?php foreach ($result as $k => $v): ?>
                    <tr id="page-<?php echo $v->id;?>">
                        ...
                        <td class="column-title">
                            <H1>
                                <a <?php if ($this->session->userdata('acl') == 'administration' || in_array($tag . '-edit', $this->session->userdata('acl'))): ?>href="/w-admin/page/edit/<?php echo $v->id;?><?php echo ($this->uri->segment(3) != 'search') ? '/' . $this->uri->segment(3, 1) : '';?>"<?php endif;?>><?php echo $v->title;?></a>
                            </H1>
                            <div class="action">
