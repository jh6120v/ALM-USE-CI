...
<?php echo form_open('w-admin/group/aSave', 'id="group" name="form" autocomplete="off"');?>
        ...
        <tr>
            ...
            <td>
                <?php foreach ($aclList as $k => $v): ?>
                    <H1><span class="inline"><input type="checkbox" name="acl[]" value="<?php echo $v['acl'];?>" id="<?php echo $v['acl'];?>" level="0" onclick="javascript:checknode(this);"> <label for="<?php echo $v['acl'];?>"><?php echo $k;?></label></span></H1>
                    <?php foreach ($v['action'] as $k2 => $v2): ?>
                        <em class="group"><span class="inline first"><input type="checkbox" name="acl[]" value="<?php echo $v2['acl'];?>" id="<?php echo $v2['acl'];?>" level="1" onclick="javascript:checknode(this);"> <label for="<?php echo $v2['acl'];?>"><?php echo $v2['name'];?></label></span>
                        <?php foreach ($v2['list_acl'] as $k3 => $v3): ?>
                            <span class="inline"><input type="checkbox" name="acl[]" value="<?php echo $v3;?>" id="<?php echo $v3;?>" level='2' onclick='javascript:checknode(this);'> <label for="<?php echo $v3;?>"><?php echo $k3;?></label></span>
                        <?php endforeach;?>
                        </em>
                    <?php endforeach;?>
                <?php endforeach;?>
