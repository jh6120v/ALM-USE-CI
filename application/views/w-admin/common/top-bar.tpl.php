    ...
    <ul id="top-bar" class="top-bar-left">
        ...
        <li id="fast-add">
            ...
            <ul class="fast-add-menu clearfix">
                <li><a href="/banner/add">橫幅廣告</a></li>
                <li><a href="/works/add">設計作品</a></li>
            </ul>
        </li>
    </ul>
    <ul id="top-bar" class="top-bar-right">
        <li id="userInfo">
            ...
            <ul class="userInfo-menu clearfix">
                <li><a href="/w-admin/account/personal"><?php echo $this->session->userdata('pName');?></a></li>
                <li><a href="/w-admin/account/personal">編輯個人資訊</a></li>
