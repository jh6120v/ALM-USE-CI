...
CKFinder.lang['zh-tw'] =
{
	...
	common :
	{
		...
		confirmCancel	: '一些選項進行了更改。您確定要關閉對話窗口？', // MISSING
		ok				: 'OK', // MISSING
		cancel			: '取消', // MISSING
		confirmationTitle	: '確認', // MISSING
		messageTitle	: '訊息', // MISSING
		inputTitle		: '問題', // MISSING
		undo			: '復原', // MISSING
		redo			: '重做', // MISSING
		skip			: '略過', // MISSING
		skipAll			: '全部略過', // MISSING
		makeDecision	: '應該採取什麼行動？', // MISSING
		rememberDecision: '記住我的決定' // MISSING
	},
	...
	FolderRenaming	: ' (修改目錄...)',
	FolderDeleting	: ' (刪除目錄...)',
	DestinationFolder	: '目標文件夾', // MISSING
	...
	FilesLoading	: '載入中...',
	FilesEmpty		: '該資料夾為空', // MISSING
	DestinationFile	: '目標文件', // MISSING
	SkippedFiles	: '略過的文件列表：', // MISSING
